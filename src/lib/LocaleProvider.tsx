...
const translations: Record<Locale, Record<string, string>> = {
    fr: {
        ...
        hero_title_role: 'Étudiant M2 MIAGE — En recherche d\'alternance',
        hero_description: "Étudiant en Master MIAGE, je recherche une alternance de 12 mois pour ma deuxième année de master à partir de septembre (rythme 3 semaines en entreprise / 3 semaines en formation).\nCurieux, rigoureux et motivé, je souhaite participer à des projets concrets pour développer mes compétences.",
    ...
    en: {
        ...
        hero_title_role: 'M2 MIAGE Student — Looking for an apprenticeship',
        hero_description: "As an M2 MIAGE student, I'm looking for a 12-month apprenticeship starting in September, with a schedule of 3 weeks at the company followed by 3 weeks in training. Curious, rigorous and motivated, I want to contribute to real projects and deepen my technical skills.",
